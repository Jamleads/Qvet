...
function EditProfile() {
  return (
    <div className="md:flex  md:items-center md:p-6 md:justify-between">
      <div className="editprofile md:w-[536px] md:h-[544px] ">
        ...
        <div className="form w-[382px] h-[391px] top-[178px] left-[24px] gap-[24px]  mt-[20px] ml-[10px]">
          ...
          <div className="inner w-[382px] md:w-[536px] h-[328px] gap-[16px] ">
            <div className="top w-[382px] md:w-[536px] h-[100px] gap-[16px]  flex justify-around items-center px-[10px]">
              ...
              <input
                type="text"
                placeholder="Name"
                className="w-[266px] md:w-[420px]  h-[56px] p-[17px] gap-0 rounded-[12px]  bg-[#f2f2f7]"
              />
            </div>
            <input
              type="text"
              placeholder="Profile title"
              className="w-[370px] md:w-[536px]  h-[56px] p-[17px] gap-0 rounded-[12px]  bg-[#f2f2f7] pl-[30px] pr-[30px]"
            />
            <textarea
              name="bio"
              id="bio"
              ...
              className="w-[370px] md:w-[536px] h-[140px] gap-0 rounded-[12px]  bg-[#f2f2f7] mt-[20px] p-[10px]"
            ></textarea>
          </div>
        </div>
        <button className="w-[382px] md:w-[454px] h-[64px] top-[792px] left-[24px] p-[20px] px-[40px] gap-[8px] rounded-[24px]  bg-gradient-to-br from-[#552dce] via-[#7d4cda] to-[#896ddf] flex justify-center items-center">
          <Link to="/homelink">
